...
/**
 * Class m201022_105429_create_permission_of_post
 */
class m201022_105429_create_permission_of_post extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
       // echo "m201022_105242_create_permission_of_post cannot be reverted.\n";
        $auth = Yii::$app->authManager;
    ...
    {
        echo "m201022_105429_create_permission_of_post cannot be reverted.\n";
